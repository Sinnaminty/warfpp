...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_WorldstateObject_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_WorldstateObject_H_
...
///
/// </summary>
class WorldstateObject : public ModelBase {
public:
  WorldstateObject();
  virtual ~WorldstateObject();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_WorldstateObject_H_ */
