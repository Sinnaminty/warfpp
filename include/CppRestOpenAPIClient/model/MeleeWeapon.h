...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_MeleeWeapon_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_MeleeWeapon_H_
...
///
/// </summary>
class MeleeWeapon : public ModelBase {
public:
  MeleeWeapon();
  virtual ~MeleeWeapon();
  ...
  ///
  /// </summary>
  int32_t getBlockingAngle() const;
  bool blockingAngleIsSet() const;
  void unsetBlockingAngle();

  void setBlockingAngle(int32_t value);

  /// <summary>
  ///
  /// </summary>
  int32_t getComboDuration() const;
  bool comboDurationIsSet() const;
  void unsetComboDuration();

  void setComboDuration(int32_t value);

  /// <summary>
  ///
  /// </summary>
  std::vector<float> &getDamagePerShot();
  bool damagePerShotIsSet() const;
  void unsetDamagePerShot();

  void setDamagePerShot(std::vector<float> value);

  /// <summary>
  ///
  /// </summary>
  float getFollowThrough() const;
  bool followThroughIsSet() const;
  void unsetFollowThrough();

  void setFollowThrough(float value);

  /// <summary>
  ///
  /// </summary>
  int32_t getHeavyAttackDamage() const;
  bool heavyAttackDamageIsSet() const;
  void unsetHeavyAttackDamage();

  void setHeavyAttackDamage(int32_t value);

  /// <summary>
  ///
  /// </summary>
  int32_t getHeavySlamAttack() const;
  bool heavySlamAttackIsSet() const;
  void unsetHeavySlamAttack();

  void setHeavySlamAttack(int32_t value);

  /// <summary>
  ///
  /// </summary>
  int32_t getHeavySlamRadialDamage() const;
  bool heavySlamRadialDamageIsSet() const;
  void unsetHeavySlamRadialDamage();

  void setHeavySlamRadialDamage(int32_t value);

  /// <summary>
  ///
  /// </summary>
  int32_t getHeavySlamRadius() const;
  bool heavySlamRadiusIsSet() const;
  void unsetHeavySlamRadius();

  void setHeavySlamRadius(int32_t value);
  ...
  ///
  /// </summary>
  int32_t getSlamAttack() const;
  bool slamAttackIsSet() const;
  void unsetSlamAttack();

  void setSlamAttack(int32_t value);

  /// <summary>
  ///
  /// </summary>
  int32_t getSlamRadialDamage() const;
  bool slamRadialDamageIsSet() const;
  void unsetSlamRadialDamage();

  void setSlamRadialDamage(int32_t value);

  /// <summary>
  ///
  /// </summary>
  int32_t getSlamRadius() const;
  bool slamRadiusIsSet() const;
  void unsetSlamRadius();

  void setSlamRadius(int32_t value);

  /// <summary>
  ///
  /// </summary>
  int32_t getSlideAttack() const;
  bool slideAttackIsSet() const;
  void unsetSlideAttack();

  void setSlideAttack(int32_t value);

  /// <summary>
  ///
  /// </summary>
  std::shared_ptr<Polarity> getStancePolarity() const;
  bool stancePolarityIsSet() const;
  void unsetStancePolarity();

  void setStancePolarity(const std::shared_ptr<Polarity> &value);

  /// <summary>
  ///
  /// </summary>
  float getWindUp() const;
  bool windUpIsSet() const;
  void unsetWindUp();

  void setWindUp(float value);
...
protected:
  ...
  int32_t m_BlockingAngle;
  bool m_BlockingAngleIsSet;
  int32_t m_ComboDuration;
  bool m_ComboDurationIsSet;
  std::vector<float> m_DamagePerShot;
  bool m_DamagePerShotIsSet;
  float m_FollowThrough;
  bool m_FollowThroughIsSet;
  int32_t m_HeavyAttackDamage;
  bool m_HeavyAttackDamageIsSet;
  int32_t m_HeavySlamAttack;
  bool m_HeavySlamAttackIsSet;
  int32_t m_HeavySlamRadialDamage;
  bool m_HeavySlamRadialDamageIsSet;
  int32_t m_HeavySlamRadius;
  bool m_HeavySlamRadiusIsSet;
  float m_Range;
  bool m_RangeIsSet;
  int32_t m_SlamAttack;
  bool m_SlamAttackIsSet;
  int32_t m_SlamRadialDamage;
  bool m_SlamRadialDamageIsSet;
  int32_t m_SlamRadius;
  bool m_SlamRadiusIsSet;
  int32_t m_SlideAttack;
  bool m_SlideAttackIsSet;
  std::shared_ptr<Polarity> m_StancePolarity;
  bool m_StancePolarityIsSet;
  float m_WindUp;
  bool m_WindUpIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_MeleeWeapon_H_ */
