...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Sortie_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Sortie_H_

#include "CppRestOpenAPIClient/ModelBase.h"

#include "CppRestOpenAPIClient/model/Sortie_allOf_faction.h"
#include "CppRestOpenAPIClient/model/Sortie_allOf_factionKey.h"
...
class Sortie_allOf_variants;

/// <summary>
///
/// </summary>
class Sortie : public ModelBase {
public:
  Sortie();
  virtual ~Sortie();
  ...
  ///
  /// </summary>
  std::set<std::shared_ptr<Sortie_allOf_variants>> &getVariants();
  bool variantsIsSet() const;
  void unsetVariants();

  void
  setVariants(const std::set<std::shared_ptr<Sortie_allOf_variants>> &value);
  ...
  ///
  /// </summary>
  std::shared_ptr<Sortie_allOf_faction> getFaction() const;
  bool factionIsSet() const;
  void unsetFaction();

  void setFaction(const std::shared_ptr<Sortie_allOf_faction> &value);

  /// <summary>
  ///
  /// </summary>
  std::shared_ptr<Sortie_allOf_factionKey> getFactionKey() const;
  bool factionKeyIsSet() const;
  void unsetFactionKey();

  void setFactionKey(const std::shared_ptr<Sortie_allOf_factionKey> &value);
...
protected:
  ...
  std::set<std::shared_ptr<Sortie_allOf_variants>> m_Variants;
  bool m_VariantsIsSet;
  utility::string_t m_Boss;
  bool m_BossIsSet;
  std::shared_ptr<Sortie_allOf_faction> m_Faction;
  bool m_FactionIsSet;
  std::shared_ptr<Sortie_allOf_factionKey> m_FactionKey;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Sortie_H_ */
