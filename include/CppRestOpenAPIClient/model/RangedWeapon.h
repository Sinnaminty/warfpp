...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_RangedWeapon_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_RangedWeapon_H_
...
///
/// </summary>
class RangedWeapon : public ModelBase {
public:
  RangedWeapon();
  ...
  ///
  /// </summary>
  int32_t getMagazineSize() const;
  bool magazineSizeIsSet() const;
  void unsetMagazineSize();

  void setMagazineSize(int32_t value);

  /// <summary>
  ///
  /// </summary>
  float getMultishot() const;
  bool multishotIsSet() const;
  void unsetMultishot();

  void setMultishot(float value);

  /// <summary>
  ///
  /// </summary>
  utility::string_t getNoise() const;
  bool noiseIsSet() const;
  void unsetNoise();

  void setNoise(const utility::string_t &value);
...
protected:
  ...
  double m_Ammo;
  bool m_AmmoIsSet;
  int32_t m_MagazineSize;
  bool m_MagazineSizeIsSet;
  float m_Multishot;
  bool m_MultishotIsSet;
  utility::string_t m_Noise;
  bool m_NoiseIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_RangedWeapon_H_ */
