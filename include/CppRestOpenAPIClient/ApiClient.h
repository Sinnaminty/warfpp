...
public:
  ...
  static utility::string_t parameterToString(Platform value);
  static utility::string_t parameterToString(Language value);
  template <class T>
...
template <class T>
utility::string_t
ApiClient::parameterToString(const std::shared_ptr<T> &value) {
