...
void ApiClient::setConfiguration(
    std::shared_ptr<const ApiConfiguration> configuration) {
  m_Configuration = configuration;
}
...
utility::string_t ApiClient::parameterToString(Platform value) {
  return value.toString();
}

utility::string_t ApiClient::parameterToString(Language value) {
  return value.toString();
}
