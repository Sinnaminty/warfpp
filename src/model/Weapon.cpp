...
bool Weapon::fromJson(const web::json::value &val) {
  bool ok = true;
...
void Weapon::toMultipart(std::shared_ptr<MultipartFormData> multipart,
...
bool Weapon::fromMultiPart(std::shared_ptr<MultipartFormData> multipart,
...
utility::string_t Weapon::getName() const { return m_Name; }

void Weapon::setName(const utility::string_t &value) {
  m_Name = value;
  m_NameIsSet = true;
}

bool Weapon::nameIsSet() const { return m_NameIsSet; }

void Weapon::unsetName() { m_NameIsSet = false; }
utility::string_t Weapon::getUniqueName() const { return m_UniqueName; }

void Weapon::setUniqueName(const utility::string_t &value) {
  m_UniqueName = value;
  m_UniqueNameIsSet = true;
}

bool Weapon::uniqueNameIsSet() const { return m_UniqueNameIsSet; }

void Weapon::unsetUniqueName() { m_UniqueNameIsSet = false; }
utility::string_t Weapon::getDescription() const { return m_Description; }

void Weapon::setDescription(const utility::string_t &value) {
  m_Description = value;
  m_DescriptionIsSet = true;
}

bool Weapon::descriptionIsSet() const { return m_DescriptionIsSet; }

void Weapon::unsetDescription() { m_DescriptionIsSet = false; }
utility::string_t Weapon::getType() const { return m_Type; }

void Weapon::setType(const utility::string_t &value) {
  m_Type = value;
  m_TypeIsSet = true;
}

bool Weapon::typeIsSet() const { return m_TypeIsSet; }

void Weapon::unsetType() { m_TypeIsSet = false; }
bool Weapon::isTradable() const { return m_Tradable; }

void Weapon::setTradable(bool value) {
  m_Tradable = value;
  m_TradableIsSet = true;
}

bool Weapon::tradableIsSet() const { return m_TradableIsSet; }

void Weapon::unsetTradable() { m_TradableIsSet = false; }
utility::string_t Weapon::getCategory() const { return m_Category; }

void Weapon::setCategory(const utility::string_t &value) {
  m_Category = value;
  m_CategoryIsSet = true;
}

bool Weapon::categoryIsSet() const { return m_CategoryIsSet; }

void Weapon::unsetCategory() { m_CategoryIsSet = false; }
utility::string_t Weapon::getProductCategory() const {
  return m_ProductCategory;
}

void Weapon::setProductCategory(const utility::string_t &value) {
  m_ProductCategory = value;
  m_ProductCategoryIsSet = true;
}

bool Weapon::productCategoryIsSet() const { return m_ProductCategoryIsSet; }

void Weapon::unsetProductCategory() { m_ProductCategoryIsSet = false; }
std::vector<std::shared_ptr<Patchlog>> &Weapon::getPatchlogs() {
  return m_Patchlogs;
}

void Weapon::setPatchlogs(const std::vector<std::shared_ptr<Patchlog>> &value) {
  m_Patchlogs = value;
  m_PatchlogsIsSet = true;
}

bool Weapon::patchlogsIsSet() const { return m_PatchlogsIsSet; }

void Weapon::unsetPatchlogs() { m_PatchlogsIsSet = false; }
std::vector<std::shared_ptr<ShallowItem>> &Weapon::getComponents() {
  return m_Components;
}

void Weapon::setComponents(
    const std::vector<std::shared_ptr<ShallowItem>> &value) {
  m_Components = value;
  m_ComponentsIsSet = true;
}

bool Weapon::componentsIsSet() const { return m_ComponentsIsSet; }

void Weapon::unsetComponents() { m_ComponentsIsSet = false; }
std::shared_ptr<Introduced> Weapon::getIntroduced() const {
  return m_Introduced;
}

void Weapon::setIntroduced(const std::shared_ptr<Introduced> &value) {
  m_Introduced = value;
  m_IntroducedIsSet = true;
}

bool Weapon::introducedIsSet() const { return m_IntroducedIsSet; }

void Weapon::unsetIntroduced() { m_IntroducedIsSet = false; }
utility::datetime Weapon::getEstimatedVaultDate() const {
  return m_EstimatedVaultDate;
}

void Weapon::setEstimatedVaultDate(const utility::datetime &value) {
  m_EstimatedVaultDate = value;
  m_EstimatedVaultDateIsSet = true;
}

bool Weapon::estimatedVaultDateIsSet() const {
  return m_EstimatedVaultDateIsSet;
}

void Weapon::unsetEstimatedVaultDate() { m_EstimatedVaultDateIsSet = false; }
utility::string_t Weapon::getUrl() const { return m_Url; }

void Weapon::setUrl(const utility::string_t &value) {
  m_Url = value;
  m_UrlIsSet = true;
}

bool Weapon::urlIsSet() const { return m_UrlIsSet; }

void Weapon::unsetUrl() { m_UrlIsSet = false; }
double Weapon::getMr() const { return m_Mr; }

void Weapon::setMr(double value) {
  m_Mr = value;
  m_MrIsSet = true;
}

bool Weapon::mrIsSet() const { return m_MrIsSet; }

void Weapon::unsetMr() { m_MrIsSet = false; }
double Weapon::getRivenDisposition() const { return m_Riven_disposition; }

void Weapon::setRivenDisposition(double value) {
  m_Riven_disposition = value;
  m_Riven_dispositionIsSet = true;
}

bool Weapon::rivenDispositionIsSet() const { return m_Riven_dispositionIsSet; }

void Weapon::unsetRiven_disposition() { m_Riven_dispositionIsSet = false; }
std::vector<std::shared_ptr<Polarity>> &Weapon::getPolarities() {
  return m_Polarities;
}

void Weapon::setPolarities(
    const std::vector<std::shared_ptr<Polarity>> &value) {
  m_Polarities = value;
  m_PolaritiesIsSet = true;
}

bool Weapon::polaritiesIsSet() const { return m_PolaritiesIsSet; }

void Weapon::unsetPolarities() { m_PolaritiesIsSet = false; }
utility::string_t Weapon::getThumbnail() const { return m_Thumbnail; }

void Weapon::setThumbnail(const utility::string_t &value) {
  m_Thumbnail = value;
  m_ThumbnailIsSet = true;
}

bool Weapon::thumbnailIsSet() const { return m_ThumbnailIsSet; }

void Weapon::unsetThumbnail() { m_ThumbnailIsSet = false; }
std::vector<utility::string_t> &Weapon::getTags() { return m_Tags; }

void Weapon::setTags(const std::vector<utility::string_t> &value) {
  m_Tags = value;
  m_TagsIsSet = true;
}

bool Weapon::tagsIsSet() const { return m_TagsIsSet; }

void Weapon::unsetTags() { m_TagsIsSet = false; }
bool Weapon::isVaulted() const { return m_Vaulted; }

void Weapon::setVaulted(bool value) {
  m_Vaulted = value;
  m_VaultedIsSet = true;
}

bool Weapon::vaultedIsSet() const { return m_VaultedIsSet; }

void Weapon::unsetVaulted() { m_VaultedIsSet = false; }
utility::string_t Weapon::getMarketCost() const { return m_MarketCost; }

void Weapon::setMarketCost(const utility::string_t &value) {
  m_MarketCost = value;
  m_MarketCostIsSet = true;
}

bool Weapon::marketCostIsSet() const { return m_MarketCostIsSet; }

void Weapon::unsetMarketCost() { m_MarketCostIsSet = false; }
utility::string_t Weapon::getBpCost() const { return m_BpCost; }

void Weapon::setBpCost(const utility::string_t &value) {
  m_BpCost = value;
  m_BpCostIsSet = true;
}

bool Weapon::bpCostIsSet() const { return m_BpCostIsSet; }

void Weapon::unsetBpCost() { m_BpCostIsSet = false; }
std::vector<std::shared_ptr<Attack>> &Weapon::getAttacks() { return m_Attacks; }

void Weapon::setAttacks(const std::vector<std::shared_ptr<Attack>> &value) {
  m_Attacks = value;
  m_AttacksIsSet = true;
}

bool Weapon::attacksIsSet() const { return m_AttacksIsSet; }

void Weapon::unsetAttacks() { m_AttacksIsSet = false; }
int32_t Weapon::getMasteryReq() const { return m_MasteryReq; }

void Weapon::setMasteryReq(int32_t value) {
  m_MasteryReq = value;
  m_MasteryReqIsSet = true;
}

bool Weapon::masteryReqIsSet() const { return m_MasteryReqIsSet; }

void Weapon::unsetMasteryReq() { m_MasteryReqIsSet = false; }
int32_t Weapon::getBuildPrice() const { return m_BuildPrice; }

void Weapon::setBuildPrice(int32_t value) {
  m_BuildPrice = value;
  m_BuildPriceIsSet = true;
}

bool Weapon::buildPriceIsSet() const { return m_BuildPriceIsSet; }

void Weapon::unsetBuildPrice() { m_BuildPriceIsSet = false; }
int32_t Weapon::getBuildTime() const { return m_BuildTime; }

void Weapon::setBuildTime(int32_t value) {
  m_BuildTime = value;
  m_BuildTimeIsSet = true;
}

bool Weapon::buildTimeIsSet() const { return m_BuildTimeIsSet; }

void Weapon::unsetBuildTime() { m_BuildTimeIsSet = false; }
int32_t Weapon::getSkipBuildTimePrice() const { return m_SkipBuildTimePrice; }

void Weapon::setSkipBuildTimePrice(int32_t value) {
  m_SkipBuildTimePrice = value;
  m_SkipBuildTimePriceIsSet = true;
}

bool Weapon::skipBuildTimePriceIsSet() const {
  return m_SkipBuildTimePriceIsSet;
}

void Weapon::unsetSkipBuildTimePrice() { m_SkipBuildTimePriceIsSet = false; }
int32_t Weapon::getBuildQuantity() const { return m_BuildQuantity; }

void Weapon::setBuildQuantity(int32_t value) {
  m_BuildQuantity = value;
  m_BuildQuantityIsSet = true;
}

bool Weapon::buildQuantityIsSet() const { return m_BuildQuantityIsSet; }

void Weapon::unsetBuildQuantity() { m_BuildQuantityIsSet = false; }
bool Weapon::isConsumeOnBuild() const { return m_ConsumeOnBuild; }

void Weapon::setConsumeOnBuild(bool value) {
  m_ConsumeOnBuild = value;
  m_ConsumeOnBuildIsSet = true;
}

bool Weapon::consumeOnBuildIsSet() const { return m_ConsumeOnBuildIsSet; }

void Weapon::unsetConsumeOnBuild() { m_ConsumeOnBuildIsSet = false; }
utility::string_t Weapon::getWikiaThumbnail() const { return m_WikiaThumbnail; }

void Weapon::setWikiaThumbnail(const utility::string_t &value) {
  m_WikiaThumbnail = value;
  m_WikiaThumbnailIsSet = true;
}

bool Weapon::wikiaThumbnailIsSet() const { return m_WikiaThumbnailIsSet; }

void Weapon::unsetWikiaThumbnail() { m_WikiaThumbnailIsSet = false; }
utility::string_t Weapon::getWikiaUrl() const { return m_WikiaUrl; }

void Weapon::setWikiaUrl(const utility::string_t &value) {
  m_WikiaUrl = value;
  m_WikiaUrlIsSet = true;
}

bool Weapon::wikiaUrlIsSet() const { return m_WikiaUrlIsSet; }

void Weapon::unsetWikiaUrl() { m_WikiaUrlIsSet = false; }
float Weapon::getCriticalChance() const { return m_CriticalChance; }

void Weapon::setCriticalChance(float value) {
  m_CriticalChance = value;
  m_CriticalChanceIsSet = true;
}

bool Weapon::criticalChanceIsSet() const { return m_CriticalChanceIsSet; }

void Weapon::unsetCriticalChance() { m_CriticalChanceIsSet = false; }
float Weapon::getCriticalMultiplier() const { return m_CriticalMultiplier; }

void Weapon::setCriticalMultiplier(float value) {
  m_CriticalMultiplier = value;
  m_CriticalMultiplierIsSet = true;
}

bool Weapon::criticalMultiplierIsSet() const {
  return m_CriticalMultiplierIsSet;
}

void Weapon::unsetCriticalMultiplier() { m_CriticalMultiplierIsSet = false; }
int32_t Weapon::getDisposition() const { return m_Disposition; }

void Weapon::setDisposition(int32_t value) {
  m_Disposition = value;
  m_DispositionIsSet = true;
}

bool Weapon::dispositionIsSet() const { return m_DispositionIsSet; }

void Weapon::unsetDisposition() { m_DispositionIsSet = false; }
float Weapon::getFireRate() const { return m_FireRate; }

void Weapon::setFireRate(float value) {
  m_FireRate = value;
  m_FireRateIsSet = true;
}

bool Weapon::fireRateIsSet() const { return m_FireRateIsSet; }

void Weapon::unsetFireRate() { m_FireRateIsSet = false; }
float Weapon::getOmegaAttenuation() const { return m_OmegaAttenuation; }

void Weapon::setOmegaAttenuation(float value) {
  m_OmegaAttenuation = value;
  m_OmegaAttenuationIsSet = true;
}

bool Weapon::omegaAttenuationIsSet() const { return m_OmegaAttenuationIsSet; }

void Weapon::unsetOmegaAttenuation() { m_OmegaAttenuationIsSet = false; }
float Weapon::getProcChance() const { return m_ProcChance; }

void Weapon::setProcChance(float value) {
  m_ProcChance = value;
  m_ProcChanceIsSet = true;
}

bool Weapon::procChanceIsSet() const { return m_ProcChanceIsSet; }

void Weapon::unsetProcChance() { m_ProcChanceIsSet = false; }
float Weapon::getReleaseDate() const { return m_ReleaseDate; }

void Weapon::setReleaseDate(float value) {
  m_ReleaseDate = value;
  m_ReleaseDateIsSet = true;
}

bool Weapon::releaseDateIsSet() const { return m_ReleaseDateIsSet; }

void Weapon::unsetReleaseDate() { m_ReleaseDateIsSet = false; }
int32_t Weapon::getSlot() const { return m_Slot; }

void Weapon::setSlot(int32_t value) {
  m_Slot = value;
  m_SlotIsSet = true;
}

bool Weapon::slotIsSet() const { return m_SlotIsSet; }

void Weapon::unsetSlot() { m_SlotIsSet = false; }
int32_t Weapon::getTotalDamage() const { return m_TotalDamage; }

void Weapon::setTotalDamage(int32_t value) {
  m_TotalDamage = value;
  m_TotalDamageIsSet = true;
}

bool Weapon::totalDamageIsSet() const { return m_TotalDamageIsSet; }

void Weapon::unsetTotalDamage() { m_TotalDamageIsSet = false; }
utility::datetime Weapon::getVaultDate() const { return m_VaultDate; }

void Weapon::setVaultDate(const utility::datetime &value) {
  m_VaultDate = value;
  m_VaultDateIsSet = true;
}

bool Weapon::vaultDateIsSet() const { return m_VaultDateIsSet; }

void Weapon::unsetVaultDate() { m_VaultDateIsSet = false; }
} // namespace model
} // namespace client
} // namespace openapitools
} // namespace org
