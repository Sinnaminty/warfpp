...
GetWorldstateByPlatform_400_response::GetWorldstateByPlatform_400_response() {
...
void GetWorldstateByPlatform_400_response::validate() {
  // TODO: implement validation
}

web::json::value GetWorldstateByPlatform_400_response::toJson() const {
...
bool GetWorldstateByPlatform_400_response::fromJson(
...
void GetWorldstateByPlatform_400_response::toMultipart(
...
bool GetWorldstateByPlatform_400_response::fromMultiPart(
    std::shared_ptr<MultipartFormData> multipart,
...
utility::string_t GetWorldstateByPlatform_400_response::getError() const {
  return m_Error;
}

void GetWorldstateByPlatform_400_response::setError(
    const utility::string_t &value) {
  m_Error = value;
  m_ErrorIsSet = true;
}

bool GetWorldstateByPlatform_400_response::errorIsSet() const {
  return m_ErrorIsSet;
}

void GetWorldstateByPlatform_400_response::unsetError() {
  m_ErrorIsSet = false;
}
int32_t GetWorldstateByPlatform_400_response::getCode() const { return m_Code; }

void GetWorldstateByPlatform_400_response::setCode(int32_t value) {
  m_Code = value;
  m_CodeIsSet = true;
}

bool GetWorldstateByPlatform_400_response::codeIsSet() const {
  return m_CodeIsSet;
}

void GetWorldstateByPlatform_400_response::unsetCode() { m_CodeIsSet = false; }
} // namespace model
} // namespace client
} // namespace openapitools
} // namespace org
