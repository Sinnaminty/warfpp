...
void WorldstateObject::validate() {
  // TODO: implement validation
}

web::json::value WorldstateObject::toJson() const {
...
bool WorldstateObject::fromJson(const web::json::value &val) {
  bool ok = true;
...
void WorldstateObject::toMultipart(std::shared_ptr<MultipartFormData> multipart,
...
bool WorldstateObject::fromMultiPart(
...
utility::string_t WorldstateObject::getId() const { return m_Id; }

void WorldstateObject::setId(const utility::string_t &value) {
  m_Id = value;
  m_IdIsSet = true;
}

bool WorldstateObject::idIsSet() const { return m_IdIsSet; }

void WorldstateObject::unsetId() { m_IdIsSet = false; }
utility::datetime WorldstateObject::getActivation() const {
  return m_Activation;
}

void WorldstateObject::setActivation(const utility::datetime &value) {
  m_Activation = value;
  m_ActivationIsSet = true;
}

bool WorldstateObject::activationIsSet() const { return m_ActivationIsSet; }

void WorldstateObject::unsetActivation() { m_ActivationIsSet = false; }
utility::datetime WorldstateObject::getExpiry() const { return m_Expiry; }

void WorldstateObject::setExpiry(const utility::datetime &value) {
  m_Expiry = value;
  m_ExpiryIsSet = true;
}

bool WorldstateObject::expiryIsSet() const { return m_ExpiryIsSet; }

void WorldstateObject::unsetExpiry() { m_ExpiryIsSet = false; }
utility::string_t WorldstateObject::getStartString() const {
  return m_StartString;
}

void WorldstateObject::setStartString(const utility::string_t &value) {
  m_StartString = value;
  m_StartStringIsSet = true;
}

bool WorldstateObject::startStringIsSet() const { return m_StartStringIsSet; }

void WorldstateObject::unsetStartString() { m_StartStringIsSet = false; }
bool WorldstateObject::isActive() const { return m_Active; }

void WorldstateObject::setActive(bool value) {
  m_Active = value;
  m_ActiveIsSet = true;
}

bool WorldstateObject::activeIsSet() const { return m_ActiveIsSet; }

void WorldstateObject::unsetActive() { m_ActiveIsSet = false; }
} // namespace model
} // namespace client
} // namespace openapitools
} // namespace org
