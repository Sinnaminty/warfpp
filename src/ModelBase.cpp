...
ModelBase::~ModelBase() {}
bool ModelBase::isSet() const { return m_IsSet; }
...
web::json::value
ModelBase::toJson(const std::shared_ptr<HttpContent> &content) {
...
web::json::value
ModelBase::toJson(const std::shared_ptr<utility::datetime> &val) {
...
bool ModelBase::fromString(const utility::string_t &val,
                           utility::string_t &outVal) {
  utility::stringstream_t ss(val);
  bool success = true;
  try {
    ss >> outVal;
...
bool ModelBase::fromString(const utility::string_t &val,
                           web::json::value &outVal) {
  outVal = web::json::value::parse(val);
  return !outVal.is_null();
}
bool ModelBase::fromString(const utility::string_t &val,
                           std::shared_ptr<HttpContent> &outVal) {
  bool ok = true;
  if (outVal == nullptr) {
    outVal = std::shared_ptr<HttpContent>(new HttpContent());
  }
  if (outVal != nullptr) {
    outVal->setData(std::shared_ptr<std::istream>(
        new std::stringstream(utility::conversions::to_utf8string(val))));
  } else {
    ok = false;
  }
  return ok;
...
bool ModelBase::fromString(const utility::string_t &val,
                           std::shared_ptr<utility::datetime> &outVal) {
  bool ok = false;
  if (outVal == nullptr) {
...
bool ModelBase::fromJson(const web::json::value &val, float &outVal) {
  outVal = (!val.is_double() && !val.is_integer())
...
bool ModelBase::fromJson(const web::json::value &val, int32_t &outVal) {
  outVal = !val.is_integer() ? std::numeric_limits<int32_t>::quiet_NaN()
                             : val.as_integer();
  return val.is_integer();
}
bool ModelBase::fromJson(const web::json::value &val, int64_t &outVal) {
  outVal = !val.is_number() ? std::numeric_limits<int64_t>::quiet_NaN()
                            : val.as_number().to_int64();
  return val.is_number();
}
bool ModelBase::fromJson(const web::json::value &val,
                         utility::string_t &outVal) {
  outVal =
      val.is_string() ? val.as_string() : utility::conversions::to_string_t("");
  return val.is_string();
}
bool ModelBase::fromJson(const web::json::value &val,
                         utility::datetime &outVal) {
  outVal = val.is_null() ? utility::datetime::from_string(
                               utility::conversions::to_string_t("NULL"),
                               utility::datetime::ISO_8601)
                         : utility::datetime::from_string(
                               val.as_string(), utility::datetime::ISO_8601);
...
bool ModelBase::fromJson(const web::json::value &val,
  ...
  if (content != nullptr) {
    ...
    if (val.has_field(
            utility::conversions::to_string_t("ContentDisposition"))) {
    ...
    if (val.has_field(utility::conversions::to_string_t("ContentType"))) {
      ...
      result =
          result &&
          ModelBase::fromJson(
              val.at(utility::conversions::to_string_t("ContentType")), value);
    ...
    if (val.has_field(utility::conversions::to_string_t("FileName"))) {
      ...
      result =
          result &&
          ModelBase::fromJson(
              val.at(utility::conversions::to_string_t("FileName")), value);
    ...
    if (val.has_field(utility::conversions::to_string_t("InputStream"))) {
      ...
      result =
          result &&
          ModelBase::fromJson(
              val.at(utility::conversions::to_string_t("InputStream")), value);
...
ModelBase::toHttpContent(const utility::string_t &name, bool value,
...
std::shared_ptr<HttpContent>
ModelBase::toHttpContent(const utility::string_t &name, float value,
                         const utility::string_t &contentType) {
  std::shared_ptr<HttpContent> content(new HttpContent);
  content->setName(name);
  content->setContentDisposition(
...
ModelBase::toHttpContent(const utility::string_t &name,
  ...
  if (value != nullptr) {
    ...
    content->setContentType(contentType);
    content->setData(std::shared_ptr<std::istream>(new std::stringstream(
        utility::conversions::to_utf8string(toJson(*value).serialize()))));
  }
  return content;
}
bool ModelBase::fromHttpContent(std::shared_ptr<HttpContent> val,
                                bool &outVal) {
